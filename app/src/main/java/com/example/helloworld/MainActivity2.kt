...
class MainActivity2 : AppCompatActivity() {
    ...
    private val tvAdapter1 = TVAdapter(this::tvOnClick)
    ...
    private fun tvOnClick(TV: TV, position: Int) {
        val prof = TV
        val secondActivityIntent = Intent(this, MainActivity3::class.java)
